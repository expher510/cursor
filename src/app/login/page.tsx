    ...
    <main className="flex min-h-screen w-full items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center space-y-4">
            <Image src="https://picsum.photos/seed/login/150/150" alt="Learning" width={100} height={100} className="mx-auto rounded-full" data-ai-hint="woman reading" />
          <CardTitle className="text-3xl font-bold font-headline">Welcome Back!</CardTitle>
          <CardDescription>
            Let's continue your daily learning routine.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
